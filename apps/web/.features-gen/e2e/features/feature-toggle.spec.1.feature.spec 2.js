...
test.describe("Toggle a task", () => {
  test("Mark a task complete", async ({ Given, When, Then, page }) => {
    await Given('I open the app with "fixtures/basic.md"', null, { page });
    ...
    steps: [
      {
        ...
        gherkinStepLine: 3,
        keywordType: "Context",
        textWithKeyword: 'Given I open the app with "fixtures/basic.md"',
        stepMatchArguments: [
          {
            group: {
              start: 20,
              value: '"fixtures/basic.md"',
              children: [
                { start: 21, value: "fixtures/basic.md", children: [{ children: [] }] },
                { children: [{ children: [] }] }
              ]
            },
      ...
      },
      {
        ...
        gherkinStepLine: 4,
        keywordType: "Action",
        textWithKeyword: 'When I toggle "Buy milk"',
        stepMatchArguments: [
          {
            group: {
              start: 9,
              value: '"Buy milk"',
              children: [
                { start: 10, value: "Buy milk", children: [{ children: [] }] },
                { children: [{ children: [] }] }
              ]
            },
            parameterTypeName: "string"
      ...
      },
      {
        ...
        gherkinStepLine: 5,
        keywordType: "Outcome",
        textWithKeyword: 'Then the Markdown contains "@done("',
        stepMatchArguments: [
          {
            group: {
              start: 22,
              value: '"@done("',
              children: [{ start: 23, value: "@done(", children: [{ children: [] }] }, { children: [{ children: [] }] }]
            },
            parameterTypeName: "string"
          }
        ]
